...
# In this version, all locations are exported as relative.
# bl_info = {
...
scnDataFilename = "C:\\Temp\\BlenderObjectLocationsRel.json";
...
for object in objects:
	...
	obloc = object.matrix_local.to_translation();
